...
int main() {
	...
	Starts start1(date1, time1, dis1, athStarts,Qualification);

	Starts start2(date2, time2, dis2, athStarts, Semifinals);
	start2.inputAtlet(&a35);
	start2.inputAtlet(&a35);
	Starts start3(date3, time3, dis3, athStarts,Qualification);
	Starts start4(date4, time3, dis3, athStarts, Semifinals);
	start1.print();
	start2.inputAtlet(&a35);
